...
\title{Testes no OpenVPN\\ Papers and Abstracts}

\author{Pedro Henrique Bufulin de Almeida \inst{1}, Gabriel Solis Corrêa\inst{2}, Flávio Rech
...
\begin{resumo} 
  ...
  hospedados nos servidores da Microsoft Azure, para observar o funcionamento e as
